        ...
        <Container>
            <div className='add-edit-page'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <TextField onChange={(e) => setEditedProduct({ ...editedProduct, description: e.target.value })} value={editedProduct.description} label="Введите описание" variant='standard' />
